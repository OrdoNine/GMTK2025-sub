...
# TODO: make this not a global, which could mean:
#		  - a node within the Game scene
#		  - a reusable node/object that each sound-playing Thing can use.
# 		or at least separate it into a different autoload.
enum Sound {
	JUMP,
	LAND,
	HURT,
